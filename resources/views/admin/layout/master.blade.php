                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            <li><i class="fa fa-puzzle-piece"></i><a href="#">Buttons</a></li>
                            ...
                            <li><i class="fa fa-file-word-o"></i><a href="#X-UA-Compatible">Typography</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                ...
                <div class="header-menu">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="{{asset('images/avatar/admin/user.jpg.jpg')}}"></span>
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="images/admin/avatar/2.jpg"></span>
                                    <div class="message media-body">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('images/admin/user.jpg')}}" alt="User Avatar">
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a href="{{ route('logout') }}" style="font-size: 100%; color: green;" 
